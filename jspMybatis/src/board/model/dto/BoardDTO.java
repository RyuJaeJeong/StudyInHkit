...
public class BoardDTO {
	...
	private int no;
	private int num;
	private String tbl;		//게시판 종류 자유게시판 자바 게시판 이런거
	...
	private int hit;
	private String ip;
	private int memberNo;	//회원번호 0 회원이 아닌 사람, 0이상의 숫자 회원번호
	private int noticeNo;	//게시판 공지글
	private String secretGubun; //비밀글이다 아니다. 
	private Date regiDate;		
	
	private String noticeGubun;	//공지글이다 아니다.
	private int child_counter; //답변글 몇개다
	
	private int preNo;			//이전글 넘버
	private String preSubject;	//이전글 제목
	private int nxtNo;			//다음글 넘버
