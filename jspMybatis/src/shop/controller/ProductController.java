		...
		// TODO Auto-generated method stub
		 ...
		 ProductDTO dto = new ProductDTO();
 	     ...
 	     if(url.contains("index.do")) {
 	    	...
 	    	System.out.println("path01 : " + img_path01);
 	    	System.out.println("path02 : " + img_path02);
 	    	System.out.println("path03 : " + img_path03);
...
// 	    		 System.out.println(fileType);
 	    	...
 	    	for (int i = 0; i < array.length; i++) {					//파일 이름과 확장자를 이용한 파일 체크
				...
				String ext = "";
				int point_index = filename.lastIndexOf(".");	//확장자
				
				
				if(point_index == -1) {					//파일은 올라왔는데 확장자가 없는 경우.
					f1.delete();
					array[i] = "-";
				...
				if(!(ext.equals("jpg")||ext.equals("jpeg")||ext.equals("gif")||ext.equals("png"))) {		//확장자가 이미지 파일이 아닌경우.
					f1.delete();
					array[i] = "-";
					continue;
				}
			...
			int blockSize = 5; //한 페이지에 보여질 페이지 블록 갯수.
			...
			int lastPage = pager[5];
			 ...
			 List<ProductDTO> arr = dao.getListAll(startRecord, lastRecord);
