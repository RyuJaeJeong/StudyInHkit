...
<table align="center" border="1" style="width:480px;">
	<c:forEach var="dto" items="${arr}" begin="0" end="${fn:length(arr)}" step="1" varStatus="status">
			...
			<tr>
				<td>
					<table border="1">
				        <tr>
				            <td id="sajin">
									...
									<c:if test="${dto.product_img != '-,-,-' }">
										...
										<img src="${path }/attach/product_img/${temp3}" style="width:50px; height:50px;">
										</a>
									</c:if>
									<%-- 
									<br>
				        ...
				        <tr>
				           <td id="khan">${dto.name}</td>
				        </tr>
				        <tr>
				           <td id="khan"><fmt:formatNumber type="number" maxFractionDigits="3" value="${dto.price }" /></td>
				        </tr>
				        <tr>
				           <td id="khan">${dto.regi_date}</td>
				        </tr>
	    			</table>
    			</td> 
	...
	<c:set var="size" value="${fn:length(arr)}"></c:set>
	
	<c:if test="${size%3 == 2 }">
	  		<td>
				<table border="1">
				        <tr>
				            <td style="width:210px; height:150px;">&nbsp;</td>
				        </tr>
				        <tr>
	...
	<c:if test="${size%3 ==1 }">
	   ...
	   <td>
			<table border="1">
				        <tr>
				            <td  style="width:210px; height:inherit;">&nbsp;</td>
				        </tr>
				        <tr>
				            <td style="width: 100px;">&nbsp;</td>
				        </tr>
