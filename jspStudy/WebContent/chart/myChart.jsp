...
<script>
  ...
  <div id="chart_div"></div>
    ...
    <button type="button" onclick="drawChart('LineChart', '${Chart_subject}', '${chart_jsonFileName }','')">직선</button>
    <button type="button" onclick="drawChart('LineChart', '${Chart_subject}', '${chart_jsonFileName }','function')">곡선</button>
