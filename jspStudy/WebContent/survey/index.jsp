...
<%@ include file="../include/inc_header.jsp" %>
  ...
  span_pageNumber :  	<span style="display:none;" id="span_pageNumber">${pageNumber}</span>	<br>
  span_list_gubun :  	<span style="display:none;" id="span_list_gubun">${list_gubun}</span>	<br>
  span_no : 		 	<span style="display:none;" id="span_no">${no}</span>					<br>
  span_search_option :  <span style="display:none;" id="span_search_option">${search_option}</span>	<br>
  span_search_data :  	<span style="display:none;" id="span_search_data">${search_data}</span> 	<br>
  span_search_data_s :  <span style="display:none;" id="span_search_data_s">${search_data_s}</span>	<br>
  span_search_data_e :  <span style="display:none;" id="span_search_data_e">${search_data_e}</span>	<br>
